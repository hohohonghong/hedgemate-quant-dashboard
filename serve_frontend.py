#!/usr/bin/env python3
"""Serve the built HedgeMate frontend and proxy /api to the backend."""
...
def main():
    parser = argparse.ArgumentParser(description="Serve built HedgeMate frontend with a local /api proxy.")
