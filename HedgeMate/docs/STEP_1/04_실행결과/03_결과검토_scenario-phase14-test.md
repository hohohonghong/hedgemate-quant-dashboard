...
- 포트폴리오 1:1 최적: SHY (점수 0.7532)
- 포트폴리오 다자산 최적: IAU + SHY (점수 0.7728)

## 4) 참조 산출물
- `docs\STEP_1\04_실행결과\01_실행결과_scenario-phase14-test.md`
- `docs\STEP_1\04_실행결과\02_분석리포트_초안_scenario-phase14-test.md`
