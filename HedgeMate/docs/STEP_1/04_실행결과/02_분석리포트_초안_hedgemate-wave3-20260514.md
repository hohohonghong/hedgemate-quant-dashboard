...
- ITA: MDD_1y_krw=-0.1357, CVaR_95_1y_krw=-0.0284
...
8. ITA (etf) - HES=0.2977 [Corr=0.084, CVaR=0.687, Stress=0.737, Sharpe=0.671, LiqPenalty=0.953]
9. XLV (defensive) - HES=0.2966 [Corr=0.033, CVaR=0.775, Stress=0.870, Sharpe=0.101, LiqPenalty=0.631]
10. IEF (bond) - HES=0.2860 [Corr=0.066, CVaR=0.981, Stress=0.657, Sharpe=0.102, LiqPenalty=0.816]
