...
- 포트폴리오 1:1 최적: IAU (점수 0.7353)

## 4) 참조 산출물
- `C:\Users\석민\Documents\cau_2026_ss\금융인공지능실습1\HedgeMate\docs\STEP_1\04_실행결과\01_실행결과_liquidity-order-smoke-20260520.md`
- `C:\Users\석민\Documents\cau_2026_ss\금융인공지능실습1\HedgeMate\docs\STEP_1\04_실행결과\02_분석리포트_초안_liquidity-order-smoke-20260520.md`
