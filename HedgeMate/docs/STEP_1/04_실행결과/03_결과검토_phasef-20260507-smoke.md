...
- 포트폴리오 1:1 최적: SHY (점수 0.6675)
- 포트폴리오 다자산 최적: IAU + SHY (점수 0.7103)
- 단일 종목 다자산 최적: BTC-USD + XLU (점수 0.6520)

## 4) 참조 산출물
- `docs/STEP_1/04_실행결과/01_실행결과_phasef-20260507-smoke.md`
- `docs/STEP_1/04_실행결과/02_분석리포트_초안_phasef-20260507-smoke.md`
