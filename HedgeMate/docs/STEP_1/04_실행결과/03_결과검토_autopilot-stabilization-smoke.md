...
- 포트폴리오 1:1 최적: GLD (점수 0.7053)
- 포트폴리오 다자산 최적: SHY + IAU (점수 0.7616)

## 4) 참조 산출물
- `docs\STEP_1\04_실행결과\01_실행결과_autopilot-stabilization-smoke.md`
- `docs\STEP_1\04_실행결과\02_분석리포트_초안_autopilot-stabilization-smoke.md`
