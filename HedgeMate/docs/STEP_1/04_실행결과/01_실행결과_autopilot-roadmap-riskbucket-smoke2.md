...
- 실행일(UTC): 2026-05-13T11:04:04.122018+00:00
...
- 1:1 최적 후보: GLD (최종점수 0.6689, CVaR 개선률 8.18%, Sharpe 개선률 7.77%)
- 다자산 최적 조합: SHY + IAU (최종점수 0.6676, CVaR 개선률 8.48%, Sharpe 개선률 6.56%)
...
- `outputs\reports\dq_result_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\processed\features_summary_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\metric_validation_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\hes_components_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\processed\asset_risk_sensitivity_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\asset_sensitivity_summary_autopilot-roadmap-riskbucket-smoke2.md`
- `outputs\processed\asset_scenario_sensitivity_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\asset_scenario_sensitivity_summary_autopilot-roadmap-riskbucket-smoke2.md`
- `outputs\reports\asset_scenario_sensitivity_visual_autopilot-roadmap-riskbucket-smoke2.html`
- `outputs\reports\recommendation_status_qa_autopilot-roadmap-riskbucket-smoke2.md`
- `outputs\reports\portfolio_1to1_hedge_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\portfolio_multi_hedge_autopilot-roadmap-riskbucket-smoke2.csv`
- `outputs\reports\portfolio_compare_autopilot-roadmap-riskbucket-smoke2.csv`
