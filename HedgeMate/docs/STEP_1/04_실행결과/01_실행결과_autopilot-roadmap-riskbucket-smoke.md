...
- 실행일(UTC): 2026-05-13T11:02:41.115926+00:00
...
- `outputs\reports\dq_result_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\processed\features_summary_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\metric_validation_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\hes_components_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\processed\asset_risk_sensitivity_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\asset_sensitivity_summary_autopilot-roadmap-riskbucket-smoke.md`
- `outputs\processed\asset_scenario_sensitivity_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\asset_scenario_sensitivity_summary_autopilot-roadmap-riskbucket-smoke.md`
- `outputs\reports\asset_scenario_sensitivity_visual_autopilot-roadmap-riskbucket-smoke.html`
- `outputs\reports\recommendation_status_qa_autopilot-roadmap-riskbucket-smoke.md`
- `outputs\reports\portfolio_1to1_hedge_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\portfolio_multi_hedge_autopilot-roadmap-riskbucket-smoke.csv`
- `outputs\reports\portfolio_compare_autopilot-roadmap-riskbucket-smoke.csv`
