...
- 단일 종목 질의 모드: PASS (`005930.KS` 분석 가능)

## 3) 품질 검토
- DQ 결과: PASS 5 / WARN 65 / FAIL 0
- 지표 검증셋: PASS 7 / FAIL 0
- 포트폴리오 1:1 최적: SHY (점수 0.6575)
- 포트폴리오 다자산 최적: SHY + IAU (점수 0.7049)
- 단일 종목 다자산 최적: BTC-USD + SHY (점수 0.6330)

## 4) 참조 산출물
- `docs/STEP_1/04_실행결과/01_실행결과_latest-20260507-scenario.md`
- `docs/STEP_1/04_실행결과/02_분석리포트_초안_latest-20260507-scenario.md`
