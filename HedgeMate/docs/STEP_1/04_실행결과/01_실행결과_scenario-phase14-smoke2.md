...
- 실행일(UTC): 2026-04-15T11:06:26.285516+00:00
...
- 1:1 최적 후보: SHY (최종점수 0.7323, CVaR 개선률 9.13%, Sharpe 개선률 0.60%)
- 다자산 최적 조합: IAU + SHY (최종점수 0.7529, CVaR 개선률 8.71%, Sharpe 개선률 4.48%)
...
- `outputs\reports\dq_result_scenario-phase14-smoke2.csv`
- `outputs\processed\features_summary_scenario-phase14-smoke2.csv`
- `outputs\reports\metric_validation_scenario-phase14-smoke2.csv`
- `outputs\reports\hes_components_scenario-phase14-smoke2.csv`
- `outputs\processed\asset_risk_sensitivity_scenario-phase14-smoke2.csv`
- `outputs\reports\asset_sensitivity_summary_scenario-phase14-smoke2.md`
- `outputs\reports\portfolio_1to1_hedge_scenario-phase14-smoke2.csv`
- `outputs\reports\portfolio_multi_hedge_scenario-phase14-smoke2.csv`
- `outputs\reports\portfolio_compare_scenario-phase14-smoke2.csv`
