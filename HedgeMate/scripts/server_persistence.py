...
class PersistenceStore:
    ...
    def _portfolio_with_assets(self, row):
        ...
        return {
            ...
            "latestAnalysisRunId": normalized.get("latestAnalysisRunId", ""),
            "latestAnalysisAt": normalized.get("latestAnalysisAt", ""),
            "latestAnalysisFingerprintHash": normalized.get("latestAnalysisFingerprintHash", ""),
            "latestAnalysisPortfolioKey": normalized.get("latestAnalysisPortfolioKey", ""),
